...
<form class="p-3 border border-info" action="form_belanja2.php" method="POST">
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="customer" name="text" placeholder="Nama Customer" type="text" class="form-control">
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="custom-control custom-radio custom-control-inline">
        <input name="produk" id="text1" type="radio" class="custom-control-input" value="TV"> 
